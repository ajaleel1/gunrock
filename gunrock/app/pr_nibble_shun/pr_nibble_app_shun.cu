...
#include <gunrock/app/pr_nibble_shun/pr_nibble_enactor_shun.cuh>
#include <gunrock/app/pr_nibble_shun/pr_nibble_test_shun.cuh>
...
double gunrock_pr_nibble(gunrock::util::Parameters &parameters, GraphT &graph,
                         ValueT *h_values) {
  typedef typename GraphT::VertexT VertexT;
  typedef gunrock::app::pr_nibble_shun::Problem<GraphT> ProblemT;
  typedef gunrock::app::pr_nibble_shun::Enactor<ProblemT> EnactorT;
...
float pr_nibble(const SizeT num_nodes, const SizeT num_edges,
  ...
  gunrock::app::pr_nibble_shun::UseParameters(parameters);
